...
- An {{site.data.keyword.appconfig_notm}} instance: You manage the instance and the data that is collected in the instance. For more information, see [Data security](/docs/cloud-logs?topic=app-config-mng-data).
...
- For {{site.data.keyword.appconfig_notm}}, see [Data security](/docs/app-config?topic=app-config-mng-data). 
