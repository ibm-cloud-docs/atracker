...
| Monitor {{site.data.keyword.atracker_short}} targets  |  | You can configure alerts in the {{site.data.keyword.mon_short}} to monitor the health and status of your targets, detect problems writing events, and send notifications to the {{site.data.keyword.en_full_notm}} service. |
