...
| Authorize access to send data to the {{site.data.keyword.appconfig_notm}} service | {{site.data.keyword.atracker_full_notm}} | {{site.data.keyword.appconfig_notm}} | 
...
- [Authorize working with the {{site.data.keyword.apprapp_full}} service](/docs/atracker?topic=atracker-iam-service-auth-appconfig). 
