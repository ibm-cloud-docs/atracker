...
# Managing streaming to an {{site.data.keyword.at_short}} instance by using the API (WIP)
{: #streaming-manage-api-l2l}

API not available for L2L
{: important}

{{site.data.keyword.at_full}} provides an API that you can use to configure streaming for an {{site.data.keyword.la_full_notm}} instance.
{: shortdesc}
