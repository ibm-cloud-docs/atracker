...
## `ibmcloud atracker target create` ({{site.data.keyword.appconfig_notm}})
...
## `ibmcloud atracker target update` ({{site.data.keyword.appconfig_notm}})
{: #target-update-cli-appconfig}

Use this command to update an {{site.data.keyword.appconfig_notm}} target to be used to configure a destination for activity events.
