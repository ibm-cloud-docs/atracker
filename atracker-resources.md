...
* A target can be:
   ...
   * An {{site.data.keyword.logs_full_notm}} offering
    ...
    * An {{site.data.keyword.apprapp_full_notm}} offering
...
| {{site.data.keyword.apprapp_full_notm}} | `app_config`   | [Managing App Configuration targets](/docs/atracker?topic=atracker-target_v2_appconfig&interface=cli) |
